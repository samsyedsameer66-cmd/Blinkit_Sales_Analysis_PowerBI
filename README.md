...
1. Download `Blinkit_Sales_Analysis_PowerBI.pbix` from this repo, or view it via [Google Drive](https://drive.google.com/file/d/1SlVxTKGi_IKGpWLNmOFiheRBm1KUN4OX/view?usp=sharing)
2. Open it in [Power BI Desktop](https://learn.microsoft.com/en-us/power-bi/fundamentals/desktop-get-the-desktop) (free)
